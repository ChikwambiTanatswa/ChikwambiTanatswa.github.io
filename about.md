...
## My Approach
Depth over breadth. Too many people in this field lean on copy-pasted commands without understanding why they work. My goal is to actually understand the mechanics behind every technique I use.

## My Lab
- **Kali Linux** — attack platform
- **Metasploitable2** — vulnerable target
- **Windows 10 Pro** — Windows-focused target
